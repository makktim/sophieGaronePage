...
const DEFAULT_TAGLINE = "Harcos. Őrangyal.";
...
const PRODUCT_OVERRIDES: Record<string, Partial<ShopProductDetail>> = {
  ...
  "a1b2c3d4-e5f6-7890-ab12-000000000006": {
    ...
    longDescription:
      "A Sophie Garone Duó Prémium Olvasói Csomag mindkét kötetet tartalmazza: az Ég és föld között és A felhők felett regényeket. A teljes világ egy helyen, prémium csomagolásban.",
    meta: PACKAGE_META,
  ...
  "a1b2c3d4-e5f6-7890-ab12-000000000007": {
    ...
    description:
      "A Sophie Garone Teljes Duó Érzéki Fantasy Csomag mindkét regényt és a hozzájuk tartozó különleges kiegészítőket tartalmazza. A legteljesebb élmény a szerzőpáros világából.",
    meta: PACKAGE_META,
    deliveryNote: PACKAGE_DELIVERY,
    badgeLabel: "Előrendelhető",
  ...
  "a1b2c3d4-e5f6-7890-ab12-000000000099": {
    author: "Sophie Garone",
    title: "Éles próba – teszt termék",
    description:
      "Csak az éles fizetés / email / stock teszteléséhez. A próba után törölhető.",
    longDescription:
      "Ez egy alacsony összegű belső teszttermék. Nem valódi árucikk — a webshop éles próbarendeléseihez készült.",
    meta: { type: "Teszt", language: "magyar" },
    deliveryNote: "Teszt — ne add el vásárlóknak",
    badgeLabel: "TESZT",
    imageSrc: "/assets/shop/ff.png",
    price: 200,
  },
